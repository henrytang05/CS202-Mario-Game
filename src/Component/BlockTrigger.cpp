...
// BrokenBlock
TriggerBrokenBlockWhenHitBySmall::TriggerBrokenBlockWhenHitBySmall() { sumFrame = 0.0f; }
...
TriggerBehaviour *TriggerBrokenBlockWhenHitBySmall::trigger(
...
TriggerBrokenBlockWhenHitByLarge::TriggerBrokenBlockWhenHitByLarge() { sumFrame = 0.0f; }
