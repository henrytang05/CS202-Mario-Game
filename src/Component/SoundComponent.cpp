...
void MarioSoundComponent::Play1upEffect() { PlaySound(soundsEffects[0]); }
...
void MarioSoundComponent::PlayBumpEffect() { PlaySound(soundsEffects[4]); }

void MarioSoundComponent::PlayCoinEffect() { PlaySound(soundsEffects[5]); }

void MarioSoundComponent::PlayFireballEffect() { PlaySound(soundsEffects[6]); }

void MarioSoundComponent::PlayFireworksEffect() { PlaySound(soundsEffects[7]); }

void MarioSoundComponent::PlayFlagpoleEffect() { PlaySound(soundsEffects[8]); }

void MarioSoundComponent::PlayGameOverEffect() { PlaySound(soundsEffects[9]); }
...
void MarioSoundComponent::PlayKickEffect() { PlaySound(soundsEffects[12]); }

void MarioSoundComponent::PlayMarioDieEffect() { PlaySound(soundsEffects[13]); }

void MarioSoundComponent::PlayPauseEffect() { PlaySound(soundsEffects[14]); }

void MarioSoundComponent::PlayPipeEffect() { PlaySound(soundsEffects[15]); }

void MarioSoundComponent::PlayPowerupEffect() { PlaySound(soundsEffects[16]); }
...
void MarioSoundComponent::PlayStompEffect() { PlaySound(soundsEffects[19]); }

void MarioSoundComponent::PlayVineEffect() { PlaySound(soundsEffects[20]); }

void MarioSoundComponent::PlayWarningEffect() { PlaySound(soundsEffects[21]); }

void MarioSoundComponent::PlayWorldClearEffect() {
  PlaySound(soundsEffects[22]);
}

void MarioSoundComponent::PlayTingSound() { PlaySound(soundsEffects[23]); }

CoinSoundComponent::CoinSoundComponent() {
  soundEffect = LoadSound("./assets/sounds/smb_coin.wav");
  SetSoundVolume(soundEffect, SOUND_VOLUME);
}

void CoinSoundComponent::PlayCoinEffect() { PlaySound(soundEffect); }
